 ...
 */
LIBDEGORASKINESIS_EXPORT std::string toString(OperationResult r);
...
struct LIBDEGORASKINESIS_EXPORT VelocityProfile
{
    VelocityProfile();
...
struct LIBDEGORASKINESIS_EXPORT JogParameters
{
    JogParameters();
 ...
 */
struct LIBDEGORASKINESIS_EXPORT DeviceError
{
...
LIBDEGORASKINESIS_EXPORT short toType(TravelDirection direction);

LIBDEGORASKINESIS_EXPORT short toType(Channel channel);

LIBDEGORASKINESIS_EXPORT short toType(JogMode jog_mode);

LIBDEGORASKINESIS_EXPORT short toType(StopMode stop_mode);

LIBDEGORASKINESIS_EXPORT int toType(PhysicalUnit unit);

...
#include "DegorasKinesis/IntStepper/intstepper_controller.h"
 ...
 */
class DEGORASKINESIS_EXPORT K10CR2 final : public IMotionDevice
{
public:
    ...
    /// @brief Whether @p serial belongs to a K10CR2 (Thorlabs type id 55). Pure prefix check;

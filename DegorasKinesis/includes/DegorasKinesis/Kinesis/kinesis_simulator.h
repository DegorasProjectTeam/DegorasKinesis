...
DEGORASKINESIS_EXPORT std::string toString(KinesisSimulatorResult result);
 ...
 */
DEGORASKINESIS_EXPORT bool isKinesisSimulatorRunning();
 ...
 */
DEGORASKINESIS_EXPORT KinesisSimulatorResult connectKinesisSimulator();
 ...
 */
DEGORASKINESIS_EXPORT KinesisSimulatorResult disconnectKinesisSimulator();
 ...
 */
class DEGORASKINESIS_EXPORT KinesisSimulatorSession
{
public:

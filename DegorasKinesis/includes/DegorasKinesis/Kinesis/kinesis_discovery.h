 ...
 */
DEGORASKINESIS_EXPORT types::OperationResult enumerateByTypeId(int type_id, types::ThorlabsSNList& list);
 ...
 */
DEGORASKINESIS_EXPORT bool serialMatchesTypeId(const types::ThorlabsSN& serial, int type_id);

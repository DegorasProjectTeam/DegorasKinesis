 ...
 */
DEGORASKINESIS_EXPORT std::string toString(OperationResult r);
...
struct DEGORASKINESIS_EXPORT VelocityProfile
{
    VelocityProfile();
...
struct DEGORASKINESIS_EXPORT JogParameters
{
    JogParameters();
 ...
 */
struct DEGORASKINESIS_EXPORT DeviceError
{
...
DEGORASKINESIS_EXPORT short toType(TravelDirection direction);

DEGORASKINESIS_EXPORT short toType(Channel channel);

DEGORASKINESIS_EXPORT short toType(JogMode jog_mode);

DEGORASKINESIS_EXPORT short toType(StopMode stop_mode);

DEGORASKINESIS_EXPORT int toType(PhysicalUnit unit);
